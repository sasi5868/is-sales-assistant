...
exports.postAudio = async (req, res, next) => {
  ...
  asrInputFile =
    '/home/istl/demo/voice_channel_navigation/backend/data/inputAudio/' +
    req.body.name;
  console.log('asrInputFile: ', asrInputFile);
  asrResponseFileName = req.body.name.replace('wav', 'txt');
  asrResponseFilePath =
    '/home/istl/build/bbnl_english_nlp/process_dir/' + asrResponseFileName;
  asrExecutionFile =
    '/home/istl/build/kaldi/egs/bbnl_english_asr/s5/online_run.sh ' +
    asrInputFile +
    ' ' +
    asrResponseFilePath;
  ...
  nlpResponseFilePath =
    '/home/istl/build/bbnl_english_nlp/out_dir/' + nlpResponseFileName;
  nlpExecutionFile =
    'python3.8 /home/istl/build/bbnl_english_nlp/01_process_intent_english.py ' +
    asrResponseFilePath +
    ' ' +
    nlpResponseFilePath;
