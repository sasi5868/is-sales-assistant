...
class TableCar extends Component {
  ...
  selectCarModel(event) {
    ...
    if(event.target.textContent != "Car Model") {
      this.props.setAudioTarget(event.target.textContent)
    }
    // selectedCarState.setCar(event.target.textContent);
    ...
    return (
      <>
        ...
        <div key="childComponent" className="tableContainer">
          <table>
            <thead>
              {/* <tr onClick={e => this.selectCarModel(e)}> */}
              {/* <tr onClick={(e) => this.props.handleName(e)}> */}
              <tr>
                <th>Car Model</th>
